    ...
    <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item" style="margin-left: 30px">
                            <h5> <a class="nav-link active" ariacurrent="page" href="{{ route('admin.buku') }}">Buku</a> </h5>
                        </li>
                        <li class="nav-item" style="margin-left: 30px">
                            <h5> <a class="nav-link" aria-current=" page" href="#"> Peminjaman</a> </h5>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <table class="table" style="margin-top: 10px">
            ...
            <tbody class="table-group-divider"> @foreach ($data as $index => $buku) <tr>
                    ...
                    <td> <a class="btn btn-outline-warning" href="/admin/editBuku/{{ $buku->id }}">Edit</a> <a class="btn btn-outline-danger" href="/admin/deleteBuku/{{ $buku->id }}">Delete</a> </td>
                </tr> @endforeach </tbody>
        </table><br> {{ $data->links() }}
    </div><br><br><br>
